...
export default function IOS26Button({
  ...
  const baseClasses = "inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 ios26-button accessible-button focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2";
